...
class Day6(DayChallenge):
    ...
    def run(self, input_data: Path) -> None:
        ...
        print(f"{pos_first_marker} characters need to be processed to reach the"
              f" first start-of-packet marker.")

        # PART 2
        print("\nPart 2:")
        pos_message_marker: int
        pos_message_marker = Day6.first_pos_all_different(data, 14)
        print(f"{pos_message_marker} characters need to be processed to reach"
              f" the first start-of-message marker.")
